      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <Share2 className="w-6 h-6 text-medical-600" />
            <h2 className="text-xl font-bold text-gray-900">Compartilhar Resultados</h2>
          </div>
          <button
            onClick={onClose}
          ...
          {activeTab === 'link' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-semibold transition-all ${
                  copied
                    ...
                    : 'bg-medical-50 text-medical-600 border border-medical-200 hover:bg-medical-100'
                }`}
              >
                {copied ? (
                  <>
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                <p className="text-xs text-gray-600 mb-2">Previewar:</p>
            ...
            <div className="space-y-3">
              ...
              {navigator.share && (
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-lg font-semibold text-gray-700 bg-gray-50 hover:bg-gray-100 border border-gray-200 transition-all"
                >
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-lg">
          <button
            onClick={onClose}
            className="w-full py-2 px-4 text-gray-700 font-semibold rounded-lg hover:bg-gray-100 transition-all"
          >
            Fechar
          </button>
        </div>
