...
export default function OCRTips() {
  return (
    <div className="bg-gradient-to-r from-medical-50 to-blue-50 border border-medical-300 rounded-lg p-6">
      <div className="flex items-center gap-3 mb-4">
        <Camera className="w-6 h-6 text-medical-600" />
        <h3 className="text-lg font-bold text-gray-900">📸 Dicas para Melhor Análise de Imagens</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-bold text-green-900">✓ Recomendado</h4>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-bold text-red-900">✗ Evitar</h4>
          </div>
      ...
      <div className="mt-6 pt-6 border-t border-medical-200">
        <h4 className="font-bold text-gray-900 mb-3">📋 Formato Ideal para Captura</h4>
        <div className="bg-white p-4 rounded-lg text-sm space-y-2 text-gray-700">
      ...
      <div className="mt-6 pt-6 border-t border-medical-200">
        <h4 className="font-bold text-gray-900 mb-3">🔄 Como o Processamento Funciona</h4>
        <div className="bg-white p-4 rounded-lg text-xs space-y-2 text-gray-700 font-mono">
